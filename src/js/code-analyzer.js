...
//     rows.push(new parsedRow(parsedCode['loc']['start']['line'],parsedCode['type'],parsedCode['id']['name'],'',escodegen.generate(parsedCode['init'])));
// }
//
...
//     rows.push(new parsedRow(parsedCode['loc']['start']['line'],parsedCode['type'],escodegen.generate(parsedCode['left']),'',escodegen.generate(parsedCode['right'])));
// }